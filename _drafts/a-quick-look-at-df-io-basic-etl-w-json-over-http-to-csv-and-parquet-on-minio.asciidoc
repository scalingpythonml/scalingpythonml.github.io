...
[source]
----
include::../subrepos/scalingpythonml/dask-examples/Dask\ -\ Explore\ S3MinIO.py[tags=known_fs_result]
----
...
[source, python]
----
include::../subrepos/scalingpythonml/dask-examples/Dask\ -\ Explore\ S3MinIO.py[tags=cleaned_up]
----
